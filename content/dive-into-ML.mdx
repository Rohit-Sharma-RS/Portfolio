...
- **Autoencoder for MNIST Dataset Noise removal**: Implemented an autoencoder to compress and reconstruct images from the MNIST dataset effectively removing 40% noise from data ! enhancing my understanding of unsupervised learning and neural network architectures.
...
This project tested my ability to design agents capable of making real-time decisions in dynamic environments.

## Conclusion

From basics to in-depth, my ML journey has been a rewarding experience of constant learning and I hope it will continue to be so. Whether it’s regression, classification, NLP, or reinforcement learning, each project added a layer of understanding.
