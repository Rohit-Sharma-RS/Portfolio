...
var lastUpdated = "Sep 2024";
export default function page() {
    return (<article className="prose mt-8 pb-16 dark:prose-invert">
      ...
      <div className="space-y-4">
        ...
        <p>
          ...
          showcasing my work, and I am all about respecting your privacy.
        </p>
        ...
        <p>
          ...
          an email at{" "}
          <Link href="mailto:rohitrnc5458@gmail.com">rohitrnc5458@gmail.com</Link> or use
